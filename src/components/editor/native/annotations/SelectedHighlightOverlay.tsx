...
import { Canvas, Rect as SkiaRect } from '@shopify/react-native-skia';
import { Trash2 } from 'lucide-react-native';
import type { Annotation } from '../../../../types';
import { HIGHLIGHT_DEFAULT_COLOR, HIGHLIGHT_DEFAULT_WIDTH } from '../constants';
...
export function SelectedHighlightOverlay({
  annotation,
  width,
  height,
  zoom,
